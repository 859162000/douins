...
//    	String token = "5e23971236e14c1fbf1226c8e891fa22";	
    	String transNo = "00160408110637232632";
    	nyService.queryPayResult(transNo);
...
//        user.setCertiCode("440902198607303287");
//        user.setUserName("黄伟兰");
//       
