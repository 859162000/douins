...
@XStreamAlias("RefundInfoApplyItem")
private RefundInfoApplyItem refundinfoapplyitem;


public RefundInfoApplyItem getRefundinfoapplyitem() {
	return refundinfoapplyitem;
}

public void setRefundinfoapplyitem(RefundInfoApplyItem refundinfoapplyitem) {
	this.refundinfoapplyitem = refundinfoapplyitem;
}
