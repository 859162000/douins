...
public class UserAccount extends AbstractModel{
    ...
    private String bindCardFlowNo;//绑卡交易流水号
    private String bindCardFlag;//绑卡标示
	private String creditCard;//绑定银行卡号
	private String bindPhone;//绑卡预留手机号
	private String unbindCardFlowNo;//解绑交易流水号
    ...
    public String getBindCardFlowNo() {
		return bindCardFlowNo;
	}

	public void setBindCardFlowNo(String bindCardFlowNo) {
		this.bindCardFlowNo = bindCardFlowNo;
	}
	...
	public String getUnbindCardFlowNo() {
		return unbindCardFlowNo;
	}

	public void setUnbindCardFlowNo(String unbindCardFlowNo) {
		this.unbindCardFlowNo = unbindCardFlowNo;
	}
	@Override
