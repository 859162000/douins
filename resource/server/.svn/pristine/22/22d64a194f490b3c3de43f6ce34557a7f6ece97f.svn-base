...
public class NYBankController {
    ...
    public String PayInfo(HttpServletRequest request){
    	...
    	Body body2 = new Body();
    	ResponseTrans responseTrans = processInsuredAndPay.getResponseTrans();
		if(responseTrans!=null && ResponseCode.SUCCESS.getValue().equals(responseTrans.getResponseCode())){
