...
import com.douins.common.spring.SpringContextHolder2;
...
//	private String mapper = SmsSend.class.getName();
	...
	public boolean sendSms(SmsSend smsSend,Map<String, String> data) throws Exception {		
		...
		try {
			...
			srv = ((SmsSendApplyService)SpringContextHolder2.getBean(applyType)).sendSms(smsSend.getSmsContent() ,smsSend.getMobile()) ;
