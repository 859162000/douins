...
public class UserAccountDetail extends AbstractModel{
	...
	public String toString() {
		return "UserAccountDetail [id=" + id + ", userAccountDetailId="
				+ userAccountDetailId + ", userAccountId=" + userAccountId
				+ ", businessId=" + businessId + ", businessNo=" + businessNo
				+ ", detailType=" + detailType + ", detailIo=" + detailIo
				+ ", fromAccountName=" + fromAccountName + ", fromAccountNo="
				+ fromAccountNo + ", fromBankCode=" + fromBankCode
				+ ", fromBankName=" + fromBankName + ", toAccountName="
				+ toAccountName + ", toAccountNo=" + toAccountNo
				+ ", toBankCode=" + toBankCode + ", toBankName=" + toBankName
				+ ", applyTime=" + applyTime + ", endTime=" + endTime
				+ ", applyAmount=" + applyAmount + ", status=" + status
				+ ", isvalid=" + isvalid + ", principalAmount="
				+ principalAmount + ", beginDate=" + beginDate + ", endDate="
				+ endDate + "]";
	}
