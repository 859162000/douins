...
public class ProductVo implements Serializable {
	...
	public BigDecimal getMinPrem() {
		return minPrem.setScale(0,BigDecimal.ROUND_HALF_UP);
	}
	
//	@JsonProperty("minPrem")
//	public String getMinPremDesc() {
//		return minPrem.setScale(0,BigDecimal.ROUND_HALF_UP).toString()+"元起";
//	}
	...
	public BigDecimal getSaledAmount() {
		return saledAmount.setScale(0, BigDecimal.ROUND_HALF_UP);
	}
