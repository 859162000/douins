...
public class PolicyMaster extends AbstractModel{
   ...
   // private String productName;
    ...
    private BigDecimal accuIncome;       // 当前累计总收益
    private BigDecimal yesDayIncome;    // 昨日受益
    private BigDecimal loanableAmount;      // 可贷金额
    
    private String proposalNo;                  // 投保单号（核保返回的）
    
    //查询使用
    private Date beginDate;
	private Date endDate;
	private int hesitateTerm;  
	private String chanlFlowNo;  //渠道交易流水号
