...
public class WebUseConstant {
	...
	//初始化常量
		...
		CHANL_NO = props.getProperty("CHANL_NO");
		RECIVE_BANK_ACCOUNT =props.getProperty("RECIVE_BANK_ACCOUNT");
		RECIVE_BANK_CODE =props.getProperty("RECIVE_BANK_CODE");
		...
		PROJ_CODE = props.getProperty("PROJ_CODE");
		ACCT_TYPE=props.getProperty("ACCT_TYPE");
		MRCV_ACCT_TYPE_ARRAY=props.getProperty("MRCV_ACCT_TYPE_ARRAY");
		PAY_URL=props.getProperty("PAY_URL");
		PAY_CALLBACK_URL=props.getProperty("PAY_CALLBACK_URL");
	}
	...
	public final static String  PROJ_CODE;//南粤产品编号
	public final static String  ACCT_TYPE;//支付类型
	public final static String  MRCV_ACCT_TYPE_ARRAY;//账户类型˙
	public final static String  PAY_URL;//支付url
	public final static String  PAY_CALLBACK_URL;//支付通知
	...
	public final static String MRCV_ABS_ARRAY="premium";
	public final static String URL="douins://douinsNyAccount";
