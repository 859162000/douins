...
public class HttpClientUtils {
	 ...
	 */
	public static String sendXml_Post(String url, String data, String encode) throws ClientProtocolException, IOException{
	    HttpPost httpPost = new HttpPost(url);
	    PostMethod postMethod = new PostMethod(url);
	    
	    // 请求实体
	    HttpEntity requestEntity = new StringEntity(data, encode);
	    httpPost.setEntity(requestEntity);
	   
	    // post 提交
	    //HttpResponse response = httpclient.executeMethod(postMethod);
	    return null;
	}
}
