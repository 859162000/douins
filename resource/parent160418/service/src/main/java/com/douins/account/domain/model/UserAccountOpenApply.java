...
public class UserAccountOpenApply extends AbstractModel{
	...
	public String toString() {
		return "UserAccountOpenApply [id=" + id + ", openApplyId="
				+ openApplyId + ", userId=" + userId + ", accountId="
				+ accountId + ", status=" + status + ", virtualAccountNo="
				+ virtualAccountNo + ", isvalid=" + isvalid + "]";
	}
